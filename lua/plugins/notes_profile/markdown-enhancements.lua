...
return {
  ...
  config = function()
    ...
    _G.markdown_fold_expr = function()
      ...
      -- If pcall failed, return safe default
      if not ok then
        return "="
      end
      return result
    ...
    _G.markdown_fold_text = function()
      ...
      if checkbox then
        ...
        return status .. " " .. checkbox .. "  [" .. line_count .. " lines]"
      end
      ...
      -- If pcall failed, return safe default
      if not ok then
        return "  Folded  [" .. (vim.v.foldend - vim.v.foldstart + 1) .. " lines]"
      end
      return result
    end
    ...
    vim.api.nvim_create_autocmd("FileType", {
      ...
      callback = function(args)
        ...
        -- Enable folding for all markdown files (deferred to ensure treesitter is ready)
        vim.defer_fn(function()
