...
--
-- PHASE A TEST: enabled = false - Testing if plugin loads without causing E36 crashes
-- If nvim loads successfully, try removing 'enabled = false' to test markdown rendering

return {
  'OXY2DEV/markview.nvim',
  -- enabled = false,  -- REMOVED FOR TESTING - Testing if this causes E36 crashes!
  dependencies = {
